...
const CATEGORIES = [
  ...
  {
    id: "institucional",
    name: "Rifa Institucional",
    icon: "business-outline",
    eventCategoryId: 2,
  },
  {
    id: "empresarial",
    name: "Rifa Empresarial",
...
export default function Step3CategoryContent({
  form,
  setForm,
  onNext,
  onBack,
  ...
  const handleNext = () => {
    if (!form.eventCategoryId) {
      Alert.alert(
        "Error de Validación",
        "Por favor, selecciona una categoría para el evento.",
      );
      return;
    }
    ...
    >
      <View style={styles.stepContent}>
        ...
        <Text style={styles.stepSubtitleText}>
          Clasifica tu evento para que los compradores lo encuentren fácilmente
          en el catálogo.
        </Text>
