...
export default function SellerConfirmarTickets() {
  ...
  const navigateToConfirm = () => {
    ...
    router.push({
      pathname: "/(app)/(seller)/tickets/ingresarDatosVenta",
      params: {
        eventId,
        collectionId,
  ...
  const renderItem = ({ item }) => {
    ...
    // Derive display name and initial from buyer info
    ...
    // Format creation date in Spanish
...
const styles = StyleSheet.create({
  ...
  // Avatar circle with buyer initials
  avatarCircle: {
    width: 44,
    height: 44,
    borderRadius: 22,
