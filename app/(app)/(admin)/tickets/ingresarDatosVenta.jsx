...
// ── Main screen ────────────────────────────────────────────────────────────────
export default function AdminIngresarDatosVenta() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (failed === 0) {
        router.replace({
          pathname: "/(app)/(admin)/tickets/exitoConfirmar",
              ...
              <View style={styles.imagePickerRow}>
                ...
                >
                  <View style={styles.imagePickerIcon}>
                    <Ionicons name="camera-outline" size={24} color={GREEN_900} />
                  </View>
                ...
                >
                  <View style={styles.imagePickerIcon}>
                    <Ionicons name="image-outline" size={24} color={GREEN_900} />
                  </View>
